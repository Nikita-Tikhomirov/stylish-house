            ...
            <svg xmlns="http://www.w3.org/2000/svg" id="logo" viewBox="0 0 600 280">
                <defs>
                    <style>
                        ...
                        .cls-1 {
                            stroke:
                                {{ $headerInfo->logo_color }} !important;
                            stroke-width: 5.67px;
                        }
                ...
                <div class="footer__socials">
                    <a class="footer__social" href="#"> <i class="fab fa-vk"></i></a>
                    <a class="footer__social" href="#"> <i class="fab fa-telegram"></i></a>
                    <a class="footer__social" href="#"> <i class="fab fa-whatsapp"></i></a>
                </div>
                </div>
                <div class="footer__col">
                    <div class="footer__linkList">
                        <div class="footer__listTitle">Шторы </div>
                        <ul>
                    ...
                    <div class="footer__linkList">
                        <div class="footer__listTitle">Жалюзи </div>
                        <ul>
                ...
                <div class="footer__col">
                    ...
                    <div class="footer__phoneWrap">
                        <div class="footer__phoneText">Остались вопросы? Звоните</div><a
                            href="tel:{{ $headerInfo->phone_number }}">{{ $headerInfo->phone_number }}</a>
                    </div>
                    <div class="footer__info">
                        <div class="footer__infoIcon"> <i class="far fa-clock"></i></div><span>{{ $headerInfo->working_hours }}</span>
                    </div>
                    <div class="footer__info">
                        <div class="footer__infoIcon"> <i class="far fa-clock"></i></div><span>{{ $headerInfo->address }}</span>
                    </div>
                </div>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', () => {
                        const contactForms = document.querySelectorAll('.formAjax, .popupForm');
                        ...
                        contactForms.forEach(element => {
                            element.addEventListener('submit', async function(e) {
                                ...
                                try {
                                    ...
                                    alert('Сервер не ответил или ошибка в JS');
                                }
                            });
                        });
                    })
