        ...
        <section class="s-catMain wrapper">
            ...
            <div class="breadcrumbs">
                <ul class="breadcrumbs__list">
                    <li class=""><a class="breadcrumbs__link" href="{{ \App\Support\CanonicalUrl::route('front.home') }}">Главная</a></li>
            ...
            <div class="prodForm">
                ...
                <div class="prodForm__calcFormWrap">
                    ...
                    <x-front.read-more :text="$product->first_screenn_description"
                        :id="'template-product-summary-'.$product->id" />
...
<input type="hidden" class="discount" value="{{ $product->discount }}">
        ...
        @if ($showGateScheme ?? false)
            <x-front.section.sectional-gates-scheme
                :title="$gateSchemeTitle ?? 'Конструкция секционных ворот'"
                :paragraphs="$gateSchemeParagraphs ?? [
                ...
                :list-title="$gateSchemeListTitle ?? 'Основные элементы конструкции секционных ворот:'"
            />
        @endif
                    ...
                    <div class="accardion__content">
                        @if ($seoCats->isNotEmpty())
                            @foreach ($seoCats as $cat)
                                <a class="s-tags__tag"
                                    href="{{ \App\Support\CanonicalUrl::route('subcategory.show', ['category_slug' => $cat->category->slug, 'subcategory_slug' => $cat->slug]) }}">
