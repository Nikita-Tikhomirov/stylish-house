@props([
    'title' => 'Конструкция секционных ворот',
    'paragraphs' => [
    ...
    'listTitle' => 'Основные элементы конструкции секционных ворот:',
])

<section class="sectionalScheme wrapper">
    <div class="sectionalScheme__media">
        <img src="{{ asset('img/sectional-gates-scheme.png') }}" alt="{{ $title }}">
    </div>
    <div class="sectionalScheme__content">
        ...
        <h3 class="sectionalScheme__subtitle">{{ $listTitle }}</h3>
