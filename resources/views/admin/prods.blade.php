...
<style>
    ...
    .cardsHeader {
        display: grid;
        grid-template-columns: 0.2fr 0.4fr 2fr 2fr 2fr 0.5fr 0.5fr 0.5fr;
        background: #f9f9ff;
    }
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="section-block" id="basicform" tabindex="-1">
            ...
            <div class="add-category">
                <a href="/admin/product/create" class="btn-sm btn-primary">Добавить товар</a>


            </div>
            <form id="filter-form" class="prodsFilter">
                <input type="text" name="search" id="search" placeholder="Поиск по названию" class="form-control">
        ...
        <div class="section-blok">
            <div class="cards-wrap">
                <div class="cardsHeader">
                    ...
                    <div class="cardsHeader__title">Категория</div>
                    <div class="cardsHeader__title">Подкатегория</div>
                ...
                <div id="pagination" class="prodsPagination">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.getElementById("filter-form").addEventListener("submit", function (e) {
            e.preventDefault();
            fetchProducts("{{ route('product.edit') }}");
        });
