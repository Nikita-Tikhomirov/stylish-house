                        ...
                        <div class="prodForm calculator">
                            ...
                            <div class="prodForm__calcFormWrap">
                                ...
                                <div class="prodForm__priceAndAddToCart">
                                    @php
                                        $calcBasePrice = (int) ($slide->product->min_price ?? 0);
                                        $calcDiscount = (float) ($slide->product->discount ?? 0);
                                        $calcDisplayPrice = $calcBasePrice > 0 ? (int) floor($calcBasePrice * (1 - $calcDiscount / 100)) : null;
                                    @endphp
                                    <div class="prodForm__price" data-coef="{{ $slide->product->coef }}"
                                        data-base-price="{{ $calcBasePrice }}">
