...
<body class="p-index">
    ...
    <main class="layout">
            ...
            <div class="popularsWithFilter__wrap">
                <aside class="sidebarFilter">
                    ...
                    <style>
                        ...
                        .popularsWithFilter .sidebarFilter__paramsWrap {
                            height: 300px;
                            overflow-y: scroll;
                            overflow-x: hidden;
                        }

                        .sidebarFilter__subcatsList {
                            height: 300px;
                            overflow-y: scroll
                        }
                    </style>
                        ...
                        <div class="sidebarFilter__paramsWrap">
                            ...
                            @foreach ($models as $model)
                                <label class="sidebarFilter__label modelLabel">
                                    <input type="checkbox" id="modelid{{ $model->id }}" />
                    ...
                    <div class="sidebarFilter__subcatsListWrap">
                        <div class="sidebarFilter__title">Подкатегории</div>
                        <ul class="sidebarFilter__subcatsList">

                            @foreach ($subcatsForSlider->subcategories as $subcategory)
                                @if ($subcategory->show_in_cats_filter)
                                    <li>
                ...
                <div class="popularsWithFilter__cardsWrap">
                    ...
                    <div class="popularsWithFilter__cards" id="productsWrap" data-category-id="{{ $category->id }}">
                        @include('front.partials.catproducts')
                    </div>
            ...
            <div class="prodForm">
                ...
                <div class="prodForm__calcFormWrap">
                    ...
                    <x-front.read-more :text="$firstProduct->first_screenn_description"
                        :id="'category-product-summary-'.$firstProduct->id" />
                    ...
                    <input type="hidden" class="modelIdInput" value="{{ $firstProduct->model_id }}">
        ...
        @if (!empty($videoReviews) && $videoReviews->isNotEmpty())
            <x-front.section.videorevs :videoreviews="$videoReviews" :category='$category'
                title=""></x-front.section.videorevs>
        @endif
